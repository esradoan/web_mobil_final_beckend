...
namespace SmartCampus.DataAccess
{
    public class CampusDbContext : IdentityDbContext<User, Role, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Cafeterias Seed Data
            modelBuilder.Entity<Cafeteria>().HasData(
                new Cafeteria { Id = 1, Name = "Merkez Yemekhane", Location = "Ana Kampüs, A Blok Zemin Kat", Capacity = 500, IsActive = true, CreatedAt = seedDate },
                new Cafeteria { Id = 2, Name = "Mühendislik Kafeteryası", Location = "Mühendislik Fakültesi, B Blok", Capacity = 200, IsActive = true, CreatedAt = seedDate },
