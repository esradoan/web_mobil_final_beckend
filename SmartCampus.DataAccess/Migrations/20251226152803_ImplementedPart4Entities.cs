...
{
    /// <inheritdoc />
    public partial class ImplementedPart4Entities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LastValue = table.Column<double>(type: "double", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcademicNotifications = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AttendanceNotifications = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    MealNotifications = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SensorData_IoTSensors_SensorId",
                        column: x => x.SensorId,
